...
<figure>
	...
	<a class="Portfolio" href="<?php echo "$domain/website/portfolio.files"; ?>/AIB_01.png" title="full size screenshot">view cached image <span> of AIB home page</span></a>
</figure>
...
<figure>
	...
	<a class="Portfolio" href="<?php echo "$domain/website/portfolio.files"; ?>/globalEDGE_01.png" title="full size screenshot">view cached image <span> of globalEDGE home page</span></a>
</figure>
...
<ul>
	<li><a class="pdf" href="<?php echo "$domain/website/portfolio.files"; ?>/globalEDGE_ad.pdf" title="PDF link to advertisement">globalEDGE.msu.edu website ad</a></li>
	<li><a class="pdf" href="<?php echo "$domain/website/portfolio.files"; ?>/globalEDGE_diagnostic_tools_ad.pdf" title="PDF link to advertisement">Diagnostic Tools ad</a></li>
...
<figure>
	...
	<a class="pdf" href="<?php echo "$domain/website/portfolio.files"; ?>/AIB_BackgroundBoard_small.pdf" title="full-size PDF">view PDF<span> of AIB 2006 Annual Conference Banner</span></a>
</figure>
...
<figure>
	...
	<a class="pdf" href="<?php echo "$domain/website/portfolio.files"; ?>/CIBER_GrantCover.pdf" title="full-size PDF">view PDF<span> PDF of BIE grant proposal cover</span></a>
</figure>
...
<ul>
	<li><a class="pdf" href="<?php echo "$domain/website/portfolio.files"; ?>/CIBER_StudyAbroad.pdf" title="full-size PDF">Study Abroad brochure</a></li>
...
<ul>
	<li><a class="pdf" href="<?php echo "$domain/website/portfolio.files"; ?>/AIB_cd_envelope.pdf" title="AIB conference procedings cd envelope">CD envelope design<span> for AIB conference</span></a></li>
	<li><a class="pdf" href="<?php echo "$domain/website/portfolio.files"; ?>/AIB_cd_label.pdf" title="AIB conference procedings cd label">CD label design<span> for AIB conference</span></a></li>
	<li><a class="pdf" href="<?php echo "$domain/website/portfolio.files"; ?>/AIB_mail_pack.pdf" title="AIB mailing envelopes">branded evelopes<span> for AIB secretariat</span></a></li>
</ul>
